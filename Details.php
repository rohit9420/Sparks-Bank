...
<body>
  ...
  <table>
    ...
    $password = "";
    // $database="rohit"
    $conn = mysqli_connect($server, $username, $password, "rohit");
    if (!$conn) {
    ...
    ?>
    <div style="font-family: 'Baloo Bhai', cursive; background-image: linear-gradient(to bottom right, red, yellow);   font-size: 40px;
    text-align: center;
    margin: 20px;
}">
    ...
    <div class="card container">
      ...
      <form action="transfer.php" method="POST">
        ...
        <select name="reciever" id="dropdown" class="textbox" required>
          ...
          <?php
          $db = mysqli_connect("localhost", "root", "", "rohit");
    ...
    <div style="font-family: 'Baloo Bhai', cursive;   font-size: 40px;
    text-align: center;
    margin: 20px;
}">
    ...
    <div id="hojaplz">
      <img src="images/menu-bank.jpg" id="menuBtn">
    </div>
